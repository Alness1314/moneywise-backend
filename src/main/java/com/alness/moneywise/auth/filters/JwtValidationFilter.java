package com.alness.moneywise.auth.filters;
...
import com.alness.moneywise.auth.configuration.JwtTokenConfig;
import com.alness.moneywise.auth.configuration.SimpleGrantedAuthorityJsonCreator;
...
public class JwtValidationFilter extends BasicAuthenticationFilter{
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            Collection<? extends SimpleGrantedAuthority> authorities = Arrays.asList(new ObjectMapper()
